...
export const ChannelDetailsModal: React.FC<ChannelDetailsModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="animate-in zoom-in-95 w-full max-w-lg overflow-hidden rounded-2xl border border-white/[0.08] bg-surface-panel shadow-2xl shadow-black/80 duration-150"
